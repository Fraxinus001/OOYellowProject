...
class Protocol(IDCSys_Database):
    ...
    def q_beneficiaries_sss():
        ...
        if ans == "yes":
            g = input("Please input the registrant's Social Security Number (SSS): ") or "Not Available"
            return g
        else:
    ...
    def q_credentials_passport():
        ...
        if ans == "yes":
            i = input("Please input the registrant's Passport no.: ") or "Not Available"
            return i
        else:
            return "Not Available"
    ...
    def q_credentials_drivid():
        ...
        if ans == "yes":
            j = input("Please input the registrant's Driver's ID no.: ") or "Not Available"
            return j
        else:
            return "Not Available"
    ...
    def q_credentials_profession():
        ...
        if ans == "yes":
            i = input("Please input the registrant's Professional License no.: ") or "Not Available"
            return i
        else:
            return "Not Available"
    ...
    def q_credentials_valID():
        ...
        if ans == "yes":
            i = input("Please input the registrant's primary Valid ID no.: ") or "Not Available"
            return i
        else:
            return "Not Available"
    ...
    def q_credentials_nbi():
        ...
        if ans == "yes":
            i = input("Please input the registrant's NBI Clearance no.: ") or "Not Available"
            return i
        else:
            return "Not Available"
    ...
    def q_credentials_barid():
        ...
        if ans == "yes":
            i = input("Please input the registrant's Baranday ID no.: ") or "Not Available"
            return i
        else:
            return "Not Available"
    ...
    def q_taxdata_tindata():
        ...
        if ans == "yes":
            i = input("Please input the registrant's Taxpayer's Identification No.: ") or "Not Available"
            return i
        else:
            return "Not Available"
    ...
    def q_taxdata_cedula():
        ...
        if ans == "yes":
            i = input("Please input the registrant's Cedula no.: ") or "Not Available"
            return i
        else:
            return "Not Available"
    ...
    def menu(self):
        ...
        if ask == "DEMO":
            ...
            c = self.KeyEncrypt("+630000000000")
            d = self.KeyEncrypt("MM-DD-YYYY")
